...
const generateWAMessageContent = async (message, options) => {
    ...
    // Auto inject view channel (externalAdReply) for image and video messages
    const _mediaTypes = ["imageMessage", "videoMessage"]
    const _msgType = Object.keys(m)[0]
    if (_mediaTypes.includes(_msgType) && m[_msgType]) {
        const _ctx = m[_msgType].contextInfo || {}
        _ctx.externalAdReply = {
            title: "SAIRIDEV",
            body: "sairibot.my.id",
            mediaType: 1,
            ...
            sourceUrl: "https://whatsapp.com/channel/0029Vb2CZFk8Ojb8kSmVMr1Z",
        }
        m[_msgType].contextInfo = _ctx
    }
