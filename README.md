...
<img src="https://files.catbox.moe/gmu5ld.jpg" alt="SAIRIDEV" width="100%"/>
...
> **@sairidev/baileys2** — WhatsApp Web API untuk TypeScript/JavaScript.
> Terhubung langsung via **WebSocket** tanpa Selenium atau Chromium.
> Hemat RAM, cepat, dan support multi-device WhatsApp.

##

> [!WARNING]
> Library ini tidak berafiliasi dengan WhatsApp. Gunakan dengan bijak dan tidak melanggar Terms of Service WhatsApp.
...
```bash
# Stable
yarn add @sairidev/baileys2

# Edge (latest fixes)
yarn add github:SAIRIDEV/baileys2
```

```ts
import makeWASocket from '@sairidev/baileys2'
```
...
```ts
import makeWASocket, { useMultiFileAuthState } from '@sairidev/baileys2'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@sairidev/baileys2'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from '@sairidev/baileys2'

const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({ class: "@SAIRIDEV" })
logger.level = "fatal"
...
```ts
import { jidNormalizedUser, getAggregateResponsesInEventMessage } from '@sairidev/baileys2'
...
```ts
import makeWASocket, { makeInMemoryStore } from '@sairidev/baileys2'
          ...
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                payment_settings: [{ 
                   ...
                   pix_static_code:  { 
                      merchant_name: 'sairidev kawaii >\\\\\\<', 
                      key: 'example@sairidev.com', 
       ...
       interactiveButtons: [ 
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                ...
                additional_note: 'SAIRIDEV Kawaii >\\\<', 
...
await suki.sendMessage(
    ...
    { 
        album: [{
        	image: {
        		url: 'https://example.com/sairidev.jpg'
        	}, 
        	caption: 'Hay'
        }, {
        	image: Buffer, 
        	...
        	video: {
        		url: 'https://example.com/sairidev.mp4'
        	}, 
        	caption: 'Hay'
        }, {
        	video: Buffer, 
...
import { downloadMediaMessage, getContentType } from '@sairidev/baileys2'
...
<img src="https://files.catbox.moe/bv6o6e.jpg" alt="Developer" width="100%"/>

<br/>

**SAIRIDEV** — WhatsApp Bot Library

[![WA](https://img.shields.io/badge/WhatsApp-6287745498338-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/6287745498338)
[![Web](https://img.shields.io/badge/Website-sairibot.my.id-0d1117?style=for-the-badge&logo=googlechrome&logoColor=58a6ff)](https://sairibot.my.id)
[![Channel](https://img.shields.io/badge/Channel-SAIRIDEV-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://whatsapp.com/channel/0029Vb2CZFk8Ojb8kSmVMr1Z)

<br/>

> © 2025 SAIRIDEV — Licensed under MIT
